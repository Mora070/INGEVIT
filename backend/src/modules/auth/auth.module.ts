...
} from './google-cuentas.repository';
...
/**
 * Agrupa los componentes de autenticación
 * y sus dependencias.
 *
 * JwtModule proporciona la firma y
 * verificación de tokens.
 *
 * ThrottlerModule proporciona la
 * configuración y el almacenamiento
 * que necesita ThrottlerGuard.
 *
 * forwardRef permite que AuthModule y
 * UsuariosModule se referencien entre sí:
 *
 * - AuthGuard necesita UsuariosService.
 * - UsuariosController necesita AuthGuard.
 */
@Module({
  imports: [
    forwardRef(
